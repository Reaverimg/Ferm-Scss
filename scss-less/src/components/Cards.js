...
let img2 =
  "https://hcmuni.fpt.edu.vn/Data/Sites/1/media/2020-kim-vi/seo/campus/1-truong-dai-hoc-fpt-tphcm/truong-dai-hoc-fpt-tp-hcm-(7).jpg";
    ...
    <div className="container">
      <div className="card">
        ...
        <div className="card_content">
          ...
          <p className="card_description">
            D1 Street, Saigon Hi-tech Park, Long Thanh My Ward, Thu Duc City, Ho
            Chi Minh City
          </p>
        </div>
      </div>
      <div className="card card_dark">
        ...
        <div className="card_content">
          ...
          <p className="card_description">
            CCopyright @ FPT University 2022 (028) 7300 5588
